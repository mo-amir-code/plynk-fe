    ...
    <section className="py-16 md:py-24 px-4 sm:px-6">
      <div className="reveal max-w-5xl mx-auto glass rounded-3xl sm:rounded-[3rem] p-8 sm:p-12 md:p-20 text-center relative overflow-hidden shadow-xl border border-primary/20 bg-primary/5">
        ...
        <div className="relative z-10">
          ...
          <Link href="/auth/signup" className="inline-block btn-primary px-10 sm:px-12 py-4 sm:py-5 bg-primary text-white rounded-full text-lg sm:text-xl font-bold shadow-2xl shadow-primary/40 transition-transform hover:scale-105 cursor-pointer">
            Claim your link now
          </Link>
        </div>
      </div>
