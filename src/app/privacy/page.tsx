      ...
      <main className="min-h-screen pt-16 md:pt-24 pb-16 md:pb-24 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-20 animate-fade-in-up delay-150">
            {sections.map((s, i) => (
              <div key={i} className="glass rounded-[1.5rem] sm:rounded-[2rem] p-6 sm:p-8 border border-slate-200 dark:border-white/5 bg-white/20 dark:bg-white/5">
                <div className="size-10 bg-primary/10 rounded-xl flex items-center justify-center text-primary mb-5 sm:mb-6">
                  {s.icon}
                </div>
                <h3 className="text-lg sm:text-xl font-bold text-slate-900 dark:text-white mb-2 sm:mb-3">{s.title}</h3>
                <p className="text-sm sm:text-base text-slate-600 dark:text-slate-400 font-medium leading-relaxed">{s.content}</p>
              </div>
            ))}
          </div>
          ...
          <div className="space-y-8 sm:space-y-12 text-slate-700 dark:text-slate-300 animate-fade-in-up delay-300">
            <section>
              <h2 className="text-xl sm:text-2xl font-black text-slate-900 dark:text-white mb-3 sm:mb-4 uppercase tracking-wider">1. Data Storage</h2>
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-black text-slate-900 dark:text-white mb-3 sm:mb-4 uppercase tracking-wider">2. Your Rights</h2>
              <p className="text-sm sm:text-base leading-relaxed font-medium mb-4">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-black text-slate-900 dark:text-white mb-3 sm:mb-4 uppercase tracking-wider">3. Contact Us</h2>
              <p className="text-sm sm:text-base leading-relaxed font-medium">
                If you have any questions about this Privacy Policy, please reach out to our founders directly at <a href="/contact" className="text-primary hover:underline font-bold transition-all">Contact Us</a>.
              </p>
            </section>
          </div>
        </div>
