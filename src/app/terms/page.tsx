      ...
      <main className="min-h-screen pt-16 md:pt-24 pb-16 md:pb-24 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-20 animate-fade-in-up delay-150">
            {rules.map((r, i) => (
              <div key={i} className="glass rounded-[2rem] p-8 border border-slate-200 dark:border-white/5 bg-white/20 dark:bg-white/5">
                <div className="size-10 bg-blue-500/10 rounded-xl flex items-center justify-center text-blue-500 mb-6">
                  {r.icon}
                </div>
                <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-3">{r.title}</h3>
                <p className="text-slate-600 dark:text-slate-400 font-medium leading-relaxed">{r.content}</p>
              </div>
            ))}
          </div>
          ...
          <div className="space-y-12 text-slate-700 dark:text-slate-300 animate-fade-in-up delay-300">
            <section>
              <h2 className="text-2xl font-black text-slate-900 dark:text-white mb-4 uppercase tracking-wider">1. User Responsibility</h2>
            ...
            <section>
              <h2 className="text-2xl font-black text-slate-900 dark:text-white mb-4 uppercase tracking-wider">2. Account Security</h2>
              <p className="leading-relaxed font-medium mb-4">
            ...
            <section>
              <h2 className="text-2xl font-black text-slate-900 dark:text-white mb-4 uppercase tracking-wider">3. Impersonation</h2>
              <p className="leading-relaxed font-medium mb-4">
            ...
            <section>
              <h2 className="text-2xl font-black text-slate-900 dark:text-white mb-4 uppercase tracking-wider">4. Modifications</h2>
